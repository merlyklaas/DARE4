...
=======
In a matched sample of students who had nearly identical test scores (PreLAS, EBRS, math, and reading) and demographics and were equally likely to be classified as EL based on these observables, the effect of participation in the EL program was -0.0006 and insignificant. To the extent that EL program participation is based on these characteristics, we can intepret this credibly causal estimate of the effect of program participation, purged of observable variable bias.
>>>>>>> master
